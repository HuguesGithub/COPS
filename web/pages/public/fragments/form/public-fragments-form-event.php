				...
				<div class="rows-event-repeat row"%14$s>
					<div class="col-3">
						...
						<div class="custom-control custom-radio">
							<input class="custom-control-input" type="radio" id="repeat_daily" name="repeatType" value="daily">
							<label for="repeat_daily" class="custom-control-label">Quotidienne</label>
						</div>
						<div class="custom-control custom-radio">
							<input class="custom-control-input" type="radio" id="repeat_weekly" name="repeatType" value="weekly">
							<label for="repeat_weekly" class="custom-control-label">Hebdomadaire</label>
						</div>
						<div class="custom-control custom-radio">
							<input class="custom-control-input" type="radio" id="repeat_monthly" name="repeatType" value="monthly">
							<label for="repeat_monthly" class="custom-control-label">Mensuelle</label>
						</div>
						<div class="custom-control custom-radio">
							<input class="custom-control-input" type="radio" id="repeat_yearly" name="repeatType" value="yearly">
							<label for="repeat_yearly" class="custom-control-label">Annuelle</label>
						</div>
					</div>
					<div class="col-9" id="tab_daily">
						<div class="form-group row">
							...
							<input class="col-6 form-control" type="text" name="repeatInterval" id="repeatInterval" placeholder="Intervalle de répétition" value="%16$s">
						</div>
						<div class="form-group row">
							<div class="col-6">
