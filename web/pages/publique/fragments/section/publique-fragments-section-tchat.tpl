...
<section class="row tchatSection px-0">
    ...
    <div class="col-2 tchatContact"></div>
    <div class="col-12 tchatInput">
        <div class="input-group">
            <input type="text" id="tchatInput" class="form-control" placeholder="Saisie Tchat" aria-label="Saisie Tchat" aria-describedby="Saisie Tchat">
